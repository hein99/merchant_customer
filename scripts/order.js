...
function buildOrderVoucher(order)
{
  ...
  voucher += '</tr></tbody>';
  voucher += '<tfoot><tr>';
  voucher += '<td>First Payment</td> <td>&nbsp;</td> <td>'+ CURRENCY_SYMBOL +'&nbsp;' + order.first_payment_dollar + '</td>';
  voucher += '</tr>';
  voucher += '<tr>';
  voucher += '<td>&nbsp;</td> <td>';
  ...
  voucher += '</td> <td>'+ CURRENCY_SYMBOL +'&nbsp;' + order.mm_tax_amount + '</td>';
  voucher += '</tr></tbody>';
  voucher += '<tfoot><tr>';
  voucher += '<td>Second Payment</td> <td>&nbsp;</td> <td>'+ CURRENCY_SYMBOL +'&nbsp;' + order.second_payment_dollar + '</td>';
  voucher += '</tr>';
  voucher += '<tr>';
  voucher += '<td>&nbsp;</td> <td>';
